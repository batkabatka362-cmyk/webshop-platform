...
aiRouter.get('/ai/brain-feed', async (_req, res) => {
  try {
...
aiRouter.post('/ai/fraud-scan', async (_req, res) => {
  try {
...
aiRouter.get('/ai/suppliers', async (_req, res) => {
  try {
    const suppliers = await prisma.supplier.findMany({ orderBy: { createdAt: 'desc' } });
    res.json({ success: true, data: suppliers });
  } catch(e) { res.status(500).json({ success: false }); }
});
aiRouter.post('/ai/suppliers', async (req, res) => {
  try {
...
aiRouter.patch('/ai/suppliers/:id', async (req, res) => {
  try {
...
aiRouter.delete('/ai/suppliers/:id', async (req, res) => {
  try {
...
aiRouter.get('/ai/knowledge-base', async (_req, res) => {
  try {
...
aiRouter.post('/ai/knowledge-base', async (req, res) => {
  try {
...
aiRouter.delete('/ai/knowledge-base/:id', async (req, res) => {
  try {
...
aiRouter.get('/ai/persona', async (_req, res) => {
  try {
...
aiRouter.post('/ai/persona', async (req, res) => {
  try {
...
aiRouter.post('/ai/knowledge-base/scrape-url', async (req, res) => {
  try {
    const { url } = req.body;
...
aiRouter.post('/ai/rlhf/add-rule', async (req, res) => {
  try {
...
aiRouter.get('/admin/system-metrics', async (_req, res) => {
  try {
...
aiRouter.get('/admin/background-jobs', async (_req, res) => {
  try {
...
aiRouter.post('/admin/background-jobs', async (req, res) => {
  try {
...
aiRouter.get('/admin/api-keys', async (_req, res) => {
  try {
...
aiRouter.post('/admin/api-keys', async (req, res) => {
  try {
    const { name } = req.body;
...
aiRouter.delete('/admin/api-keys/:id', async (req, res) => {
  try {
...
aiRouter.patch('/orders/:id/status', async (req, res) => {
  try {
...
aiRouter.post('/webhook/qpay', async (req, res) => {
  try {
...
// Admin Stats
aiRouter.get('/admin/dashboard-stats', async (_req, res) => {
  try {
    const totalOrders = await prisma.order.count();
...
aiRouter.get('/admin/funnel-analytics', async (_req, res) => {
  try {
    const totalOrders = await prisma.order.count();
...
aiRouter.post('/storefront/checkout', async (req, res) => {
  try {
    const { orderId } = req.body;
...
aiRouter.post('/webhook/qpay/secure', async (req, res) => {
  try {
